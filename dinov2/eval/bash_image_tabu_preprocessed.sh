...
export WANDB_API_KEY=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
...
CUDA_VISIBLE_DEVICES=2 PYTHONPATH=. python dinov2/eval/linear3d_soop.py \
  ...
  --wandb-run-name soop-preprocessed-nihss-image-tabu \
